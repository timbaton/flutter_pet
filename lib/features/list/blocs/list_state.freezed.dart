...
/// @nodoc
mixin _$ListState {
  List<WorldCountry> get selected => throw _privateConstructorUsedError;
...
abstract class $ListStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<WorldCountry> selected});
}
...
class _$ListStateImpl implements _ListState {
  _$ListStateImpl({required final List<WorldCountry> selected})
      : _selected = selected;

  final List<WorldCountry> _selected;
  @override
  List<WorldCountry> get selected {
  ...
  @override
  String toString() {
    return 'ListState(selected: $selected)';
  }
...
abstract class _ListState implements ListState {
  factory _ListState({required final List<WorldCountry> selected}) =
      _$ListStateImpl;
